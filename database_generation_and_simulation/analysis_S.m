...
%%%%%%% 结果
R_PA_EWF_EOI = zeros(1,length(S_range)); %WCRT of bound 1 by EWF's allocation strategy
...
path = 'result/change_S';
mkdir(path);
save([path '/Res.mat'],'Res');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure;
plot(S_range,Res.R_PA_EWF_Wu,'r:o');
hold on;
plot(S_range,Res.R_PA_EWF_EOI,'r-o');
hold on;
plot(S_range,Res.R_PA_LWF_Wu,'k:s');
hold on;
plot(S_range,Res.R_PA_LWF_EOI,'k-s');
hold on;
plot(S_range,Res.R_Rand_EWF_Wu,'g:*');
hold on;
plot(S_range,Res.R_Rand_EWF_EOI,'g-*');
hold on;
plot(S_range,Res.R_Rand_LWF_Wu,'b:x');
hold on;
plot(S_range,Res.R_Rand_LWF_EOI,'b-x');
% return
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure;
plot(S_range,Res.Sched_PA_EWF_Wu,'r:o');
hold on;
plot(S_range,Res.Sched_PA_EWF_EOI,'r-o');
hold on;
plot(S_range,Res.Sched_PA_LWF_Wu,'k:s');
hold on;
plot(S_range,Res.Sched_PA_LWF_EOI,'k-s');
hold on;
plot(S_range,Res.Sched_Rand_EWF_Wu,'g:*');
hold on;
plot(S_range,Res.Sched_Rand_EWF_EOI,'g-*');
hold on;
plot(S_range,Res.Sched_Rand_LWF_Wu,'b:x');
hold on;
plot(S_range,Res.Sched_Rand_LWF_EOI,'b-x');
% return
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure;
plot(S_range,Res.AnaTime_PA_EWF_Wu,'r:o');
hold on;
plot(S_range,Res.AnaTime_PA_EWF_EOI,'r-o');
hold on;
plot(S_range,Res.AnaTime_PA_LWF_Wu,'k:s');
hold on;
plot(S_range,Res.AnaTime_PA_LWF_EOI,'k-s');
hold on;
plot(S_range,Res.AnaTime_Rand_EWF_Wu,'g:*');
hold on;
plot(S_range,Res.AnaTime_Rand_EWF_EOI,'g-*');
hold on;
plot(S_range,Res.AnaTime_Rand_LWF_Wu,'b:x');
hold on;
plot(S_range,Res.AnaTime_Rand_LWF_EOI,'b-x');
% return
