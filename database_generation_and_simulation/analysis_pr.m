...
%%%%%%% 结果
R_PA_EWF_EOI = zeros(1,length(pr_range)); %WCRT of bound 1 by EWF's allocation strategy
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure;
plot(pr_range,Res.R_PA_EWF_Wu,'r:o');
hold on;
plot(pr_range,Res.R_PA_EWF_EOI,'r-o');
hold on;
plot(pr_range,Res.R_PA_LWF_Wu,'k:s');
hold on;
plot(pr_range,Res.R_PA_LWF_EOI,'k-s');
hold on;
plot(pr_range,Res.R_Rand_EWF_Wu,'g:*');
hold on;
plot(pr_range,Res.R_Rand_EWF_EOI,'g-*');
hold on;
plot(pr_range,Res.R_Rand_LWF_Wu,'b:x');
hold on;
plot(pr_range,Res.R_Rand_LWF_EOI,'b-x');
% return
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure;
plot(pr_range,Res.Sched_PA_EWF_Wu,'r:o');
hold on;
plot(pr_range,Res.Sched_PA_EWF_EOI,'r-o');
hold on;
plot(pr_range,Res.Sched_PA_LWF_Wu,'k:s');
hold on;
plot(pr_range,Res.Sched_PA_LWF_EOI,'k-s');
hold on;
plot(pr_range,Res.Sched_Rand_EWF_Wu,'g:*');
hold on;
plot(pr_range,Res.Sched_Rand_EWF_EOI,'g-*');
hold on;
plot(pr_range,Res.Sched_Rand_LWF_Wu,'b:x');
hold on;
plot(pr_range,Res.Sched_Rand_LWF_EOI,'b-x');
% return
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure;
plot(pr_range,Res.AnaTime_PA_EWF_Wu,'r:o');
hold on;
plot(pr_range,Res.AnaTime_PA_EWF_EOI,'r-o');
hold on;
plot(pr_range,Res.AnaTime_PA_LWF_Wu,'k:s');
hold on;
plot(pr_range,Res.AnaTime_PA_LWF_EOI,'k-s');
hold on;
plot(pr_range,Res.AnaTime_Rand_EWF_Wu,'g:*');
hold on;
plot(pr_range,Res.AnaTime_Rand_EWF_EOI,'g-*');
hold on;
plot(pr_range,Res.AnaTime_Rand_LWF_Wu,'b:x');
hold on;
plot(pr_range,Res.AnaTime_Rand_LWF_EOI,'b-x');
% return
